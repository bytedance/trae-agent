...
class DockerToolExecutor:
    ...
    def __init__(self, 
        ...
        self._host_workspace_dir = os.path.abspath(host_workspace_dir) if host_workspace_dir else None
    ...
    async def parallel_tool_call(self, tool_calls: list[ToolCall]) -> list[ToolResult]:
        ...
        print("[yellow]Warning: Parallel tool calls are executed sequentially in Docker mode.[/yellow]")
    ...
    def _execute_in_docker(self, tool_call: ToolCall) -> ToolResult:
        ...
        try:
            ...
            # --- Rule 3: Handling json_edit_tool ---
                ...
                raise NotImplementedError(f"The logic for Docker execution of tool '{tool_call.name}' is not implemented.")
