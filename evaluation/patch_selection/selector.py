...
def main():
    ...
    _ = parser.add_argument("--instances_path", default="swe_bench/swebench-verified.json", help="Path to instances JSON file")
    ...
    _ = parser.add_argument("--config_file", type=str, default="config.yaml", help="Path to config file")
